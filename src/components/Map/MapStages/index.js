        ...
        <div className={Style.stages} key={moduleIndex}>
          {moduleIndex === 0 ? (
            <>
              <KickStart />
              {module.map((cue, i) => {
                let checkpointIndex = store[moduleIndex].findIndex(
                  (cue) => cue.is_Checkpoint === true
                );
                ...
                if (i < checkpointIndex) {
                  ...
                  if (cueLength % 2 === 0) {
                    middle = [
                      Math.floor((cueLength - 1) / 2),
                      Math.ceil((cueLength - 1) / 2),
                    ];
                    if (i < middle[0]) {
                  ...
                  if (cueLength % 2 === 0) {
                    ...
                    if (iAfter < middle[0]) {
                      ...
                      translateValue =
                        middle[1] * 80 - (iAfter - middle[1]) * 80;
                    }
                  } else {
                    middle = Math.ceil(cueLength / 2);
                    if (iAfter < middle) {
            ...
            <>
              ...
              {module.map((cue, i) => {
                let secretKeyIndex = store[moduleIndex].findIndex(
                  (cue) => cue.Secret_Key === true
                );
                let moduleLength = store[moduleIndex].length;
                let cueLength = null;
                let translateValue = null;
